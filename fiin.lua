local keyList = {
    "FxDFRzkJVhBigkvEAKJicaeVnyjhCXCf",
    "GUHvqhxXMfBBxrqEIcYsPyprqCwbiYyH",
    "YoQcpCiwaGXzqVCZyDxmKBUBlwHCMNkb",
    "HuNNEaUYqsbtkrCkTMyCyrctUopnLwfS",
    "ZPbPJDlvnPGbagksliDFExxRqeFJxOrA",
}
math.randomseed(os.time())
script_key = keyList[math.random(#keyList)]
...
getgenv().gagConfig = {
    ...
    BUY_EGGS = { "Gem Egg", "Jungle Egg", "Fall Egg", "Bee Egg", "Common Summer Egg", "Rare Summer Egg", "Rare Egg", "Common Egg", "Uncommon Egg", "Paradise Egg", "Legendary Egg", "Mythical Egg"},
    PLANT_EGGS = {"Paradise Egg", "Gem Egg", "Safari Egg", "Jungle Egg", },
    ...
    KEEP_PETS = { "Goblin Miner", "Ruby Squid", "Diamond Panther", "Lion", "Hydra", "Elephant", "Mummy", "Lich", "Hex Serpent", ["Ghost Bear"] = 8, "Headless Horseman", "Reaper", "Fortune Squirrel", 
		...
		"Butterfly", "Raccoon", "Queen Bee", "Mega Queen Bee", "Dragonfly", "Red Fox","Topaz Snail",
